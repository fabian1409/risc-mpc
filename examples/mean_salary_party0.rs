...
fn main() -> Result<()> {
    ...
    let mut party = PartyBuilder::new(PARTY_0, ch)
        ...
        .register(XRegister::x11.into(), Integer::Public(n).into())? // salaries0 length
        .register(XRegister::x12.into(), Integer::Public(U64_BYTES * n).into())? // salaries1 address
        .register(XRegister::x13.into(), Integer::Public(k).into())? // salaries1 length
        .address_range(
            0x0,
            salaries
                .iter()
