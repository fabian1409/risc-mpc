...
//! crate.
//!
//! Based on <https://github.com/encryptogroup/FLUTE/blob/main/crates/zappot/src/util/aes_rng.rs>.
...
impl AesRng {
    /// Create a new random number generator using a random seed from `rand::random`.
    #[inline]
    pub fn new() -> Self {
        let seed = rand::random::<Block>();
        AesRng::from_seed(seed.to_le_bytes())
    }
}
